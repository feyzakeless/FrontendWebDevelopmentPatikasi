...
let mainSection = document.querySelector(".section-center")
let createInner = "";
document.querySelectorAll(".btn-container button").forEach(function(btn){
  btn.addEventListener("click",function(e){
      if(e.currentTarget.dataset.id == "All"){
        menu.map((obj) => {
          createInner += createFoods(obj)
        })
      }else{
        menu.map((obj) => {
      ...
      mainSection.innerHTML = createInner;
      createInner = "";
    })
})
